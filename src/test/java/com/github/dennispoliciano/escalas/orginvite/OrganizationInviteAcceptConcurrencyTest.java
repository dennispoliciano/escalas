...
public class OrganizationInviteAcceptConcurrencyTest extends AbstractIntegrationTest {
    ...
    void whenTwoUsersAcceptTheSameInviteConcurrently_thenOnlyOneSucceeds() throws Exception {
        Organization org = organizationRepository.save(new Organization("igreja-concorrencia", "Igreja Concorrencia", "church", "Rua Concorrencia, 1"));
        ...
        User userA = userRepository.save(new User("concorrencia.a@email.com", passwordEncoder.encode("senha123")));
        User userB = userRepository.save(new User("concorrencia.b@email.com", passwordEncoder.encode("senha123")));
        ...
        boolean succeededA = resultA.get();
        boolean succeededB = resultB.get();
        executor.shutdown();
